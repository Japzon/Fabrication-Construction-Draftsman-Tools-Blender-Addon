...
class URDF_Properties(bpy.types.PropertyGroup):
    ...
    ratio_value: bpy.props.FloatProperty(name="Ratio", default=1.0, description="The multiplication factor for the gear/mimic relationship", update=core.update_ratio_live)
    ratio_invert: bpy.props.BoolProperty(name="Invert", default=False, description="Invert the direction of the driven motion", update=core.invert_ratio_update)
